...
static const char *WIN_BG[]   = { "Nsxiv.window.background",   "#1b1616" };
static const char *WIN_FG[]   = { "Nsxiv.window.foreground",   "#ffe8e8" };
static const char *MARK_FG[]  = { "Nsxiv.mark.foreground",     "#eb4d82" };
static const char *DEFAULT_WIN_ALPHA  = "0.84";
#if HAVE_LIBFONTS
